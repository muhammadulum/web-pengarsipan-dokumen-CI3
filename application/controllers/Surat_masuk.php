...
class Surat_masuk extends CI_Controller 
{
...

    {
        ...
        $this->load->view('template/header');
        $this->load->view('suratmasuk/data',$data);
        $this->load->view('template/footer');
    }


  function update($id_surat_masuk)
  {
      $data['ambil']=$this->m_surat_masuk->GetId($id_surat_masuk);
      $data['hasil']=$this->m_surat_masuk->tampil_departemen();
      $this->load->view('template/header');
      $this->load->view('suratmasuk/v_edit',$data);
      $this->load->view('template/footer');
  }
...
public function tambah()
  {
    $data['hasil']=$this->m_proposal->tampil_departemen();
      $this->load->view('template/header');
      $this->load->view('suratmasuk/forma',$data);
      $this->load->view('template/footer');
  }
  ...
  public function uploadImage()
  {
    ...
    $this->m_proposal->input_data($data,'tbl_surat_masuk');
    $this->session->set_flashdata('message','<div class="alert alert-success alert-dismissible fade show" role="alert">
...
function hapus($id_surat_masuk)
  {
      $this->m_surat_masuk->HapusPenjadwalan($id_surat_masuk);
      $this->session->set_flashdata('message','<div class="alert alert-danger alert-dismissible fade show" role="alert">
