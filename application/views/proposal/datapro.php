<div class="card mt-3">
  ...
  <?= $this->session->flashdata('message'); ?>
  	<a href="<?= base_url('surat_proposal/tambah'); ?>"class="btn btn-success mb-3">Input Data Baru</a>
    ...
    <table class="table table-border table-hovered table-striped">
		...
		<?php
                ...
                ?>
		<td>
		<a href="<?php echo base_url()?>surat_proposal/update/<?php echo $q->id_proposal; ?>" class="btn btn-success" role="button">Update</a>
			<a href="<?php echo base_url()?>surat_proposal/hapus/<?php echo $q->id_proposal; ?>" class="btn btn-danger" role="button" onclick="return confirm ('Apakah anda yakin')">Delete</a>
		</td>
	</tr>
	<?php endforeach; ?>
    </table>
