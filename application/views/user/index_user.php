            ...
            <li><a href="">Arsip</a>
                <ul class="sub1">
                    ...
                    <li><a href="<?= base_url('proposal_user'); ?>">Proposal</a></li>
                        ...
                        <li><a href="<?= base_url('penjadwalan_user'); ?>">Penjadwalan</a></li>
                        <li><a  href="<?= base_url('inventaris_user'); ?>">Inventaris</a></li>
            ...
            <div class="row">
               <div class="col-md-12 col-sm-12">
                  <div class="text-contant">
                     <h2>
                        <span class="center mt-50px"><span class="icon"><img src="images/icon-logo-h.png" alt="#" /></span></span>
            ...
            <div class="row">
               <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="service-widget">
                     <div class="post-media wow fadeIn">
                        <a href="images/col1.jpeg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="images/col1.jpeg" alt="" class="img-responsive">
                     </div>
                     <h3>Humanika Goes To School</h3>
                  </div>
                  <!-- end service -->
               </div>
               <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="service-widget">
                     <div class="post-media wow fadeIn">
                        <a href="images/col2.jpeg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="images/col2.jpeg" alt="" class="img-responsive">
                     </div>
                     <h3>Humanika Foto di kelas</h3>
                  </div>
                  <!-- end service -->
               </div>
               <div class="col-md-3 col-sm-6 col-xs-12">
