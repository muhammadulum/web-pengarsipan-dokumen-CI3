...
<body>
<div class="container">
    <h3>Update LPJ id ke <?php echo $ambil->id_lpj; ?></h3>
    <!-- <form action="<?php echo base_url()?>surat_lpj/simpan_update" method="post"> -->
    <?php echo form_open_multipart('surat_lpj/simpan_update');?>
    
        <input type="hidden" name="id_lpj"  value="<?php echo $ambil->id_lpj; ?>" />
